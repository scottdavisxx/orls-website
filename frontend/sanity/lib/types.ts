...
export type CtaWithMediaCardBlock = {_type: 'ctaWithMediaCard'; _key: string; title?: string; blurb?: PortableTextBlock[]; imageAndAltText?: ImageAndAltText; cta?: {href?: string; buttonText?: string; newTab?: boolean}}
